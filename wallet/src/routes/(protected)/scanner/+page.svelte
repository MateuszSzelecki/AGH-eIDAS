...
<div class="scanner-container">
    {#if permission != "granted"}
        <div class="glass-card">
            ...
            <h2
                style="font-family: 'Inter', sans-serif; font-weight: 600; font-size: 1.8rem; margin-top: 0; margin-bottom: 10px; letter-spacing: 0.5px;"
            >
                Camera Required
            </h2>
            <p>Please grant camera permissions to scan verification codes.</p>
            <button class="action-btn" onclick={requestCameraPermissions}
    ...
    {:else if scanning}
        ...
        <div class="scan-overlay">
            ...
            <button class="cancel-btn" onclick={() => (scanning = false)}
                >Cancel</button
            >
        </div>
    {:else if result.callbackUrl}
        <div class="glass-card">
            ...
            <h2
                style="font-family: 'Inter', sans-serif; font-weight: 500; font-size: 2rem; margin-top: 0; margin-bottom: 8px; letter-spacing: 1px;"
            >
                Verify Age?
            </h2>
            <p style="color: #7AAACE; font-size: 14px; margin-bottom: 24px;">
                <strong>{result.verifierName}</strong> is asking for your age proof.
            </p>
            ...
            >
                <button class="action-btn" onclick={handleYes}
                    >Generate ZK Proof</button
                >
                <button
                    class="text-btn"
                    onclick={handleNo}
                    style="color: #ff6b6b; opacity: 0.8; font-size: 14px; background: none; border: none; cursor: pointer;"
    ...
    {:else if loading}
        ...
        >
            <div
                class="top-bar"
                style="background: #5A7E9A; box-shadow: 0 0 10px #5A7E9A;"
            ></div>
            ...
            <h2
                style="font-family: 'Coolvetica', sans-serif; font-weight: 500; margin-top: 40px; margin-bottom: 15px; font-size: 22px;"
            >
                Generating Proof...
            </h2>
            <p
                style="font-size: 14px; color: #9CD5FF; opacity: 0.7; margin-bottom: 10px; max-width: 250px; margin-left: auto; margin-right: auto;"
            >
    ...
    {:else if success}
        ...
        <div class="glass-card">
            <div
                class="top-bar"
                style="background: #4ade80; box-shadow: 0 0 12px #4ade80;"
            ></div>
            <div
                class="status-badge"
            ...
            <h2
                style="font-family: 'Coolvetica', sans-serif; font-weight: 500;"
            >
                Identity Verified
            </h2>
            <p
                style="margin-bottom: 30px; font-size: 14px; color: rgba(255, 255, 255, 0.7);"
            >
                Your zero-knowledge proof was generated and verified
                successfully.
            </p>
    ...
    {:else}
        ...
        <div class="glass-card">
            ...
            <h3>Scanner Ready</h3>
            <p>
                Scan a QR code to provide proof of identity without sharing
                sensitive data.
            </p>
